      ...
      >
        <CardContent className="flex items-center gap-3 p-3 py-0">
          <DialogTrigger asChild>
            <div className="font-Inter flex flex-1 cursor-pointer items-center gap-3">
              ...
              <div className="flex flex-1 flex-col justify-center text-left">
                <h3 className="text-foreground/80 mb-1 line-clamp-2 text-sm leading-tight font-semibold">
                  {cert.title}
                </h3>
